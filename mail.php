...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo $currentUrl; ?>/wp-content/themes/photographer/css/components/basic_style.css">
    <link rel="stylesheet" type="text/css"
        href="<?php echo $currentUrl; ?>/wp-content/themes/photographer/css/components/stars_button.css">
    <link rel="stylesheet" type="text/css"
        href="<?php echo $currentUrl; ?>/wp-content/themes/photographer/css/fonts.css">
    <link rel="stylesheet" type="text/css"
        href="<?php echo $currentUrl; ?>/wp-content/themes/photographer/css/style.css">
    <title>Thanks</title>
</head>
...
<body>
    ...
    @media screen and (max-width: 768px) {
        ...
        .star_blue-text span:before,
        .star_blue-text span:after {
