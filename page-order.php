			...
			<div class="order_main-item">
				...
				<div class="oreder_body-text">
					<div class='order_description'>
						<p class="text">Enter your contact information so we can contact you for details. After that you can proceed with delivery details </p>
						<p class="text">We do not distribute or share customer data with third parties</p>
					</div >
					<div class='order_description none'>
						<p class="text">Enter your delivery information for us to deliver the product without mistakes. After that you can proceed with payment</p>
						<p class="text">We do not distribute or share customer data with third parties</p>
					</div>
					<div class='order_description none'>
						<p class="text">Enter your payment information after selecting payment model (Banküberweisung or Kreditkarte) . </p>
						<p class="text">We do not distribute or share customer data with third parties</p>
					</div>
				</div>	
			</div>
